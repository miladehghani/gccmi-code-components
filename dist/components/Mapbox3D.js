 ...
 */
function Mapbox3D(_ref) {
  var style = _ref.style,
    locations = _ref.locations,
    accessToken = _ref.accessToken,
    animationDuration = _ref.animationDuration;
  _esm["default"].accessToken = accessToken;
  ...
  (0, _react.useEffect)(function () {
    var loadCSS = /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var response, cssText, _style;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return fetch("https://cdn.jsdelivr.net/npm/mapbox-gl@3.4.0/dist/mapbox-gl.css");
            case 3:
            ...
            case 12:
              ...
              console.error("Failed to load CSS file:", _context.t0);
            case 15:
            case "end":
  ...
  var getBoundingBox = function getBoundingBox(_ref3, padding) {
    var west = _ref3.west,
      east = _ref3.east,
      north = _ref3.north,
      south = _ref3.south;
  ...
  (0, _react.useEffect)(function () {
    ...
    map.current.on("load", function (e) {
      locations.forEach(function (location) {
        var _location$position = location.position,
          west = _location$position.west,
          east = _location$position.east,
          north = _location$position.north,
          south = _location$position.south;
        var coordinates = [[+west, +north], [+east, +north], [+east, +south], [+west, +south]];
        location.images.forEach(function (image, index) {
          var sourceId = "source-".concat(index);
          var layerId = "layer-".concat(index);
...
Mapbox3D.defaultProps = {
  accessToken: "pk.eyJ1IjoiM3NpZGVkY3ViZSIsImEiOiJjam55amZrdjIwaWY3M3FueDAzZ3ZjeGR2In0.DhSsxs-8XhbTgoVmFcs94Q",
  locations: []
};
(0, _framer.addPropertyControls)(Mapbox3D, {
  accessToken: {
    ...
    control: {
      ...
      controls: {
        ...
        images: {
          type: _framer.ControlType.Array,
          control: {
            type: _framer.ControlType.Image
          }
        }
      }
    }
